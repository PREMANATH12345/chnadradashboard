...
import { User, Building2, UserCircle, Mail, Phone, MapPin, Calendar, Search, Filter, X, Eye, ChevronDown, ChevronUp } from 'lucide-react';
...
const Users = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      // Calculate stats
      const vendorCount = usersData.filter(user => user.user_type === 'vendor').length;
      const customerCount = usersData.filter(user => user.user_type === 'customer').length;
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h3 className="font-bold text-gray-800">{user.name || 'Unnamed User'}</h3>
                      ...
                      <div className="space-y-3">
                        ...
                        {user.address && (
                          <div className="flex items-start space-x-2">
                            ...
                            <span className="text-sm text-gray-600 flex-1">{user.address}</span>
                          </div>
                        )}
              ...
              >
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="font-bold text-lg text-gray-800">{user.name || 'Unnamed User'}</h3>
                ...
                <button
                  onClick={() => handleViewDetails(user)}
                  className="w-full flex items-center justify-center space-x-2 bg-blue-500 hover:bg-blue-600 text-white px-4 py-3 rounded-lg font-medium transition-all duration-200 hover:shadow-md"
                >
                  <Eye className="w-4 h-4" />
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-gray-800">{selectedUser.name || 'Not provided'}</p>
                    </div>
                    <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-800 capitalize">{selectedUser.user_type}</p>
                    </div>
                    <div>
                    ...
                    {selectedUser.updated_at && (
                      <div>
                        ...
                        <p className="text-gray-800">{formatDate(selectedUser.updated_at)}</p>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Current status of the user account</p>
                    </div>
