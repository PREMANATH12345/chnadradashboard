...
const Faqs = ({ onBack }) => {
  ...
  if (loading && faqs.length === 0) {
    return (
      <div className="min-h-screen bg-gray-50 p-3 sm:p-4">
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-lg sm:rounded-xl shadow-md border border-emerald-100 p-4 sm:p-6">
            <div className="flex items-center justify-center space-x-2 text-emerald-600">
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-3 sm:p-4">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="bg-white rounded-lg sm:rounded-xl shadow-md border border-emerald-100 p-4 sm:p-5 mb-4 sm:mb-6">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-3 sm:gap-4">
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <div className="min-w-0">
                <h1 className="text-lg sm:text-xl font-bold text-gray-800 mb-0.5 sm:mb-1 truncate">
                  FAQ Management
                </h1>
            ...
            <div className="flex items-center space-x-2 sm:space-x-3 w-full lg:w-auto mt-3 lg:mt-0">
              {/* Mobile Filter Toggle */}
              <button
                onClick={() => setShowMobileFilters(!showMobileFilters)}
                className="lg:hidden p-2 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors flex-shrink-0"
              >
              ...
              <button
                onClick={handleAddFaq}
                className="px-3 sm:px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white font-medium rounded-lg flex items-center space-x-1 sm:space-x-2 transition-all duration-200 shadow-md hover:shadow-lg text-sm sm:text-base w-full lg:w-auto justify-center"
              >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mt-4 sm:mt-6">
            ...
            <div className="bg-purple-50 border border-purple-100 rounded-lg sm:rounded-xl p-3 sm:p-4">
            ...
            <div className="bg-amber-50 border border-amber-100 rounded-lg sm:rounded-xl p-3 sm:p-4">
          ...
          {showMobileFilters && (
            <div className="mt-4 p-3 bg-gray-50 rounded-lg lg:hidden">
              <div className="space-y-3">
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <Search className="h-3 h-4 text-gray-400" />
                  </div>
                  <input
                    type="text"
                    ...
                    value={searchTerm}
                    onChange={(e) => setSearchTerm(e.target.value)}
                    className="block w-full pl-9 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 bg-white text-sm"
                  />
                </div>
          ...
          <div className="hidden lg:grid grid-cols-1 md:grid-cols-4 gap-3 sm:gap-4 mt-4 sm:mt-6">
            {/* Search Input */}
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <Search className="h-4 w-4 text-gray-400" />
        ...
        <div className="space-y-3 sm:space-y-4">
          {filteredFaqs.map((faq) => (
            <div
              key={faq.id}
              className="bg-white rounded-lg sm:rounded-xl shadow-md border border-emerald-100 p-4 sm:p-6 hover:shadow-lg transition-all duration-200 group"
            >
              <div className="space-y-3 sm:space-y-4">
                {/* Question and Expand Button */}
                <div
                ...
                >
                  <div className="flex items-start space-x-2 sm:space-x-3 min-w-0 flex-1">
                    <div className="p-1.5 sm:p-2 bg-emerald-100 rounded-lg mt-0.5 sm:mt-1 flex-shrink-0">
                      <Eye className="w-3 h-3 sm:w-4 sm:h-4 text-emerald-600" />
                    </div>
                    <div className="min-w-0 flex-1">
                      <h3 className="text-sm sm:text-base font-bold text-gray-800 group-hover:text-emerald-600 transition-colors duration-200 line-clamp-2">
                        {faq.question || "Untitled FAQ"}
                      </h3>
                      {faq.category && (
                        <div className="flex items-center space-x-1 mt-1">
                          <Tag className="w-2 h-2 sm:w-3 sm:h-3 text-gray-400" />
                          <span className="text-xs font-medium text-emerald-500 bg-emerald-50 px-2 py-0.5 sm:py-1 rounded-full">
                            {faq.category}
                          </span>
                        </div>
                      )}
                  ...
                  <button className="text-gray-400 hover:text-emerald-500 ml-2 flex-shrink-0">
                    {expandedFaqs.includes(faq.id) ? (
                ...
                {/* Answer (Expandable) */}
                {expandedFaqs.includes(faq.id) && (
                  <div className="ml-9 sm:ml-11 pl-3 sm:pl-4 border-l-2 border-emerald-100">
                    <div className="prose prose-sm max-w-none">
                    ...
                    {/* Dates */}
                    <div className="text-xs text-gray-400 space-y-1 mt-3 sm:mt-4">
                      <div>Created: {formatDate(faq.created_at)}</div>
                      <div>Updated: {formatDate(faq.updated_at)}</div>
                      {faq.deleted_at && (
                        <div className="text-red-400">
                    ...
                    <div className="flex flex-col sm:flex-row sm:space-x-2 pt-3 sm:pt-4 mt-3 sm:mt-4 border-t border-gray-100 space-y-2 sm:space-y-0">
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          handlePreviewFaq(faq);
                        }}
                        className="py-2 bg-emerald-50 hover:bg-emerald-100 text-emerald-600 font-medium rounded-lg transition-colors duration-200 flex items-center justify-center space-x-2 text-sm"
                      >
                      ...
                      <div className="flex space-x-2">
                        <button
                          ...
                          className="flex-1 py-2 bg-emerald-50 hover:bg-emerald-100 text-emerald-600 rounded-lg transition-colors duration-200 hover:scale-105 flex items-center justify-center"
                          title="Edit FAQ"
                        >
                          <Edit2 className="w-3 h-3 sm:w-4 sm:h-4" />
                          <span className="ml-1 sm:ml-2 text-sm">Edit</span>
                        </button>
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                          ...
                          disabled={processingId === faq.id}
                          className="flex-1 py-2 bg-red-50 hover:bg-red-100 text-red-600 rounded-lg transition-colors duration-200 hover:scale-105 disabled:opacity-50 flex items-center justify-center"
                          title="Delete FAQ"
                        >
                          {processingId === faq.id ? (
                ...
                {/* Collapsed View - Quick Actions */}
                {!expandedFaqs.includes(faq.id) && (
                  <div className="ml-9 sm:ml-11 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                    <div className="text-xs sm:text-sm text-gray-500 line-clamp-2">
                      {faq.answer?.substring(0, 80) || "No answer available..."}
        ...
        {filteredFaqs.length === 0 && (
          <div className="text-center py-8 sm:py-12">
            <div className="bg-white rounded-lg sm:rounded-xl border border-emerald-100 p-6 sm:p-8 max-w-md mx-auto shadow-md">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <Eye className="w-6 h-6 sm:w-8 sm:h-8 text-emerald-500" />
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 justify-center">
                {hasActiveFilters ? (
                  <button
                    onClick={clearFilters}
                    className="bg-emerald-500 hover:bg-emerald-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-medium transition-all duration-200 shadow-md hover:shadow-lg text-sm sm:text-base"
                  >
                    Clear All Filters
                  </button>
                ) : (
                  <button
                    onClick={handleAddFaq}
                    className="bg-emerald-500 hover:bg-emerald-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-medium transition-all duration-200 shadow-md hover:shadow-lg text-sm sm:text-base flex items-center justify-center space-x-1 sm:space-x-2"
                  >
                    <Plus className="w-3 h-3 sm:w-4 sm:h-4" />
                    <span>Create Your First FAQ</span>
                  </button>
      ...
      {/* ========== ADD FAQ MODAL - Responsive ========== */}
      {showAddModal && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex min-h-screen items-center justify-center p-2 sm:p-3 md:p-4">
            <div
              className="fixed inset-0 bg-black opacity-50 transition-opacity"
              onClick={() => setShowAddModal(false)}
            ></div>

            <div className="relative z-10 bg-white rounded-lg sm:rounded-xl shadow-xl w-full max-w-md sm:max-w-lg md:max-w-2xl mx-auto overflow-hidden max-h-[90vh] overflow-y-auto">
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      value={formData.category}
                      onChange={handleInputChange}
                      className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-sm sm:text-base"
                      placeholder="e.g., General, Billing, Technical Support"
                      list="category-suggestions"
                    />
                    <datalist id="category-suggestions">
              ...
              <div className="bg-gray-50 px-4 sm:px-5 md:px-6 py-3 sm:py-4 flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-3">
                <button
                  onClick={() => setShowAddModal(false)}
                  className="px-4 sm:px-6 py-2 sm:py-3 text-xs sm:text-sm font-medium text-gray-700 hover:text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-200 w-full sm:w-auto"
                >
                  Cancel
                </button>
                <button
                  onClick={handleSubmitAdd}
                  disabled={saving}
                  className="px-4 sm:px-6 py-2 sm:py-3 bg-emerald-500 hover:bg-emerald-600 text-white font-medium rounded-lg transition-all duration-200 shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-1 sm:space-x-2 text-sm sm:text-base w-full sm:w-auto"
                >
                  {saving ? (
                    <>
                      <Loader className="w-3 h-3 sm:w-4 sm:h-4 animate-spin" />
            ...
            <div className="relative z-10 bg-white rounded-lg sm:rounded-xl shadow-xl w-full max-w-md sm:max-w-lg md:max-w-2xl mx-auto overflow-hidden max-h-[90vh] overflow-y-auto">
                ...
                <div className="max-w-3xl mx-auto">
                  <div className="flex items-center justify-between mb-4 sm:mb-6">
                    <div>
                      ...
                      {selectedFaq.category && (
                        <div className="inline-flex items-center space-x-1">
                          <Tag className="w-3 h-3 sm:w-4 sm:h-4 text-emerald-500" />
              ...
              <div className="bg-gray-50 px-4 sm:px-5 md:px-6 py-3 sm:py-4 flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-3">
                ...
                <button
                  ...
                  className="px-4 sm:px-6 py-2 sm:py-3 bg-emerald-500 hover:bg-emerald-600 text-white font-medium rounded-lg transition-all duration-200 shadow-md hover:shadow-lg flex items-center justify-center space-x-1 sm:space-x-2 text-sm sm:text-base w-full sm:w-auto"
                >
                  <Edit2 className="w-3 h-3 sm:w-4 sm:h-4" />
                  <span>Edit This FAQ</span>
                </button>
